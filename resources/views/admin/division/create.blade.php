...
<div class="row">
    <div class="col-md-12">
        <div class="card ">
            ...
            {!! Form::open(['method' => 'POST', 'route' => 'storedivision',  'class' => 'create-tag-form', 'id' => 'create_tag_form', 'role' => 'form', 'enctype' => 'multipart/form-data' ]) !!}
                <div class="card-body">
                    <input type="hidden" name="_method" value="POST">
                    @include('admin.division.partials.division-form')
                </div>
                <hr>
