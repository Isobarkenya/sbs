        ...
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title">
                    ...
                    <?php echo e(trans('laravel-filemanager::lfm.title-upload')); ?>

                </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    <span class="sr-only">
                        <?php echo trans('admin.modals.save-post.close'); ?>
                        ...
                        <div class="controls text-center">
                            <div class="input-group" style="width: 100%">
                                <a class="btn btn-primary center-block" id="upload-button">
                                    <?php echo trans('laravel-filemanager::lfm.message-choose'); ?>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">
                    ...
                    <?php echo e(trans('laravel-filemanager::lfm.btn-close')); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/larablog-master/resources/views/admin/modals/upload-modal.blade.php ENDPATH**/ ?>