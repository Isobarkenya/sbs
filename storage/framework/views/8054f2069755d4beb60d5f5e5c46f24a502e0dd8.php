                            ...
                            <tbody>
                                <?php $__currentLoopData = $dashboarddata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dashboarddata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($dashboarddata->fied1); ?>

                                        </td>
                                        <td class="hidden-sm">
                                        <?php echo e($dashboarddata->fied2); ?>

                                        </td>
                                        <td class="hidden-sm">
                                        <?php echo e($dashboarddata->fied3); ?>

                                        </td>
                                        <td class="hidden-sm">
                                        <?php echo e($dashboarddata->fied5); ?>

                                        </td>
                                        <td>
                                            <a href="/admin/dashboarddata/<?php echo e($dashboarddata->id); ?>/edit" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="left" title="<?php echo trans('tooltips.band.edit'); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/larablog-master/resources/views/admin/dashboarddata/index.blade.php ENDPATH**/ ?>