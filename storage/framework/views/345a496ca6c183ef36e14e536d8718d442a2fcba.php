        ...
        <div class="card ">
            ...
            <div class="card-footer">
                <p class="stats text-muted">
                    <?php echo trans('admin.dashboard.welcome-card-footer'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/larablog-master/resources/views/admin/pages/home.blade.php ENDPATH**/ ?>