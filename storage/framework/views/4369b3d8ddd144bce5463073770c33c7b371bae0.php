<?php $__env->startSection('template_title'); ?>
    <?php echo trans('laravelusers::laravelusers.showing-user', ['name' => $user->name]); ?>
...
<?php $__env->startSection('header_title'); ?>
    <?php echo e(trans('admin.user_pages.show.header')); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <?php echo trans('laravelusers::laravelusers.showing-user-title', ['name' => $user->name]); ?>
                ...
                <div class="card-body">
                    ...
                    <?php if($user->email): ?>
                        <p class="text-center" data-toggle="tooltip" data-placement="top" title="<?php echo trans('laravelusers::laravelusers.tooltips.email-user', ['user' => $user->email]); ?>">
                    ...
                    <div class="row mb-4">
                        <div class="col-3 offset-3 col-sm-4 offset-sm-2 col-md-4 offset-md-2 col-lg-3 offset-lg-3">
                            <a href="/users/<?php echo e($user->id); ?>/edit" class="btn btn-block btn-md btn-warning">
                                <?php echo trans('laravelusers::laravelusers.buttons.edit-user'); ?>
                        ...
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-4 col-sm-3">
                                    <strong>
                                        <?php echo trans('laravelusers::laravelusers.show-user.id'); ?>
                        ...
                        <?php if($user->name): ?>
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-4 col-sm-3">
                                        <strong>
                                            <?php echo trans('laravelusers::laravelusers.show-user.name'); ?>
                            ...
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-12 col-sm-3">
                                        <strong>
                                            <?php echo trans('laravelusers::laravelusers.show-user.email'); ?>
                        ...
                        <?php if($user->created_at): ?>
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-4 col-sm-3">
                                        <strong>
                                            <?php echo trans('laravelusers::laravelusers.show-user.created'); ?>
                        ...
                        <?php if($user->updated_at): ?>
                            <li class="list-group-item">
                                <div class="row">
                                    <div class="col-4 col-sm-3">
                                        <strong>
                                            <?php echo trans('laravelusers::laravelusers.show-user.updated'); ?>
...
<?php echo $__env->make(config('laravelusers.laravelUsersBladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/sbs/resources/views/vendor/laravelusers/usersmanagement/show-user.blade.php ENDPATH**/ ?>