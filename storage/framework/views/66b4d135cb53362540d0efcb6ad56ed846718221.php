<?php $__env->startSection('template_title'); ?>
    <?php echo trans('laravelusers::laravelusers.create-new-user'); ?>
...
<?php $__env->startSection('header_title'); ?>
    <?php echo e(trans('admin.user_pages.create.header')); ?>
                ...
                <div class="card-header">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div class="pull-right">
                            <a href="<?php echo e(route('users')); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo trans('laravelusers::laravelusers.tooltips.back-users'); ?>">
                                <?php if(config('laravelusers.fontAwesomeEnabled')): ?>
...
<?php echo $__env->make(config('laravelusers.laravelUsersBladeExtended'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/larablog-master/resources/views/vendor/laravelusers/usersmanagement/create-user.blade.php ENDPATH**/ ?>