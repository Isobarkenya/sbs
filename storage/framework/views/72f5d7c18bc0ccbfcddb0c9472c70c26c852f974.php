        ...
        <?php echo Form::open(['route' => 'search-users', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation', 'id' => 'search_users']); ?>
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <a href="#" class="btn btn-warning clear-search" data-toggle="tooltip" title="<?php echo trans('laravelusers::laravelusers.tooltips.clear-search'); ?>">
                        <?php if(config('laravelusers.fontAwesomeEnabled')): ?>
                            <i class="fas fa-times" aria-hidden="true"></i>
                            <span class="sr-only">
                                <?php echo trans('laravelusers::laravelusers.tooltips.clear-search'); ?>
...
<?php /**PATH /Applications/MAMP/htdocs/larablog-master/resources/views/vendor/laravelusers/partials/search-users-form.blade.php ENDPATH**/ ?>